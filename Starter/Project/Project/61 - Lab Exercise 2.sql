...
--both tables has custid column so database engine cant understand which table should be choosen
---------------------------------------------------------------------
...
---------------------------------------------------------------------
SELECT C.custid, contactname, O.orderid,productid, qty,unitprice
FROM Sales.Customers C
INNER JOIN Sales.Orders O ON C.custid = O.custid
